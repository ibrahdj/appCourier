    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <span class="h1"><b>Editer l'activite N°</b><?= $activite->id_activite; ?></span>
                <a href="<?php echo base_url('activite'); ?>" class="btn btn-danger float-right"> Retour </a>
            </div>
            <div class="card-body">
                <form action="<?php echo base_url('activite/update/'.$activite->id_activite); ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <div class="from-group">
                            <label for="lieu_activite">Lieu de l'activité</label>
                                <input type="text" name="lieu_activite" value="<?= $activite->lieu_activite ?>" class="form-control">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="from-group">
                                ...
                                <input type="Time" name="heure_debut" value="<?= $activite->heure_debut ?>" class="form-control">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="from-group">
                                ...
                                <input type="Time" name="heure_fin" value="<?= $activite->heure_fin ?>" class="form-control">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" id="desc" rows="3"><?= $activite->description ?></textarea>
                                ...
                                <select name="personne_id[]" class="select2 form-control" multiple="multiple" data-placeholder="Selection à multiple">
                                        ...
                                        <?php foreach ($activite->personne_all as $pers):?>
                                            <?php if($activite->id_activite == $parts->activite_id && $pers->id_personne == $parts->personne_id):?>
                                                    <option selected value="<?= $pers->id_personne ?>"><?= $pers->prenom ?> <?= $pers->nom ?></option>
                                            <?php endif; ?>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="from-group">
                                ...
                                <input type="Date" name="date_activite" value="<?= $activite->date_activite ?>" class="form-control" placeholder="Nom complet">
