...
<head>
  ...
  <!-- Favicons -->
  <link href="<?= base_url('assets/templates');?>/dist/img/logo_scse.png" rel="icon">
  <link href="<?= base_url('assets/templates');?>/dist/img/logo_scse.png" rel="apple-touch-icon">
  ...
  <main>
    <div class="container">
      <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
        ...
        <a class="btn" href="<?= base_url('dashboard') ;?>">Retourner sur l'accueil</a>
        <img src="<?= base_url('assets/templates');?>/dist/img/not-found.svg" class="img-fluid py-5" alt="Page Not Found">
